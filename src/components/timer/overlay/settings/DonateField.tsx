...
const DonateField: React.FC = () => {
                ...
                <div className="flex w-full flex-col gap-2">
                    ...
                    <DisclosurePanel className="flex flex-col gap-2">
                        <p className="text-gray-500">
                            Visual Timer is completely free to use without any functional restrictions or ads. If you
                            like this app, consider supporting the app to help keep it free and improve its features.
                        </p>
                        <a
    ...
    return <ListElement icon={heartIcon} content={donateContent} />;
};
