...
const TimerFace: React.FC<TimerFaceProps> = ({
    ...
    // Size calculation for foreignObject
    const textWidth = baseRadius * 1.5;
    const textHeight = baseRadius / 2;
        ...
        <div className="h-full">
            <svg className="size-full" viewBox="-50 -50 100 100">
                ...
                {text && (
                    ...
                    >
                        <div
                            className="flex size-full flex-col items-center justify-center text-center font-bold"
                            style={{
                                fontSize: `${progressRadius / 5}px`,
...
TimerFace.displayName = 'TimerFace';
